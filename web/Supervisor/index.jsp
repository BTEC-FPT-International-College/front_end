        ...
        %>
            $(document).ready(function () {
                ...
                var cateid = "<%=request.getParameter("id")%>"
                    ...
                    $.ajax({
                        url: "../PostControllerSupervisor?ac=view",
                        method: "GET",
                        data: {get: d},
                        success: function (data) {
                            ...
                            $.each(rs, function (key, value) {
                                ...
                                let data = ""
                                if (isBlock == 0) {
                                    data =   '<div class="container d-flex justify-content-center"> <button class="btn btn-danger " data-toggle="modal" data-target="#my-modal' + value.PostID + '">' + '<i class="mdi mdi-delete"></i>Block</button>'
                                    ...
                                    data = '<div class="container d-flex justify-content-center"> <button class="btn btn-warning " data-toggle="modal" data-target="#my-modal' + value.PostID + '">' + '<i class="mdi mdi-border-color"></i>UnBlock</button>'
                                            + '<div id="my-modal' + value.PostID + '" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">'
                                            + '<div class="modal-dialog modal-dialog-centered" role="document">'
                                            + '<div class="modal-content border-0">'
                                            + '<div class="modal-body p-0">'
                ...
                $("#getdate").click(function () {
                    ...
                    if ((end - start) < 0) {
                        ...
                        console.log(da)
                        $.ajax({
                            url: "../PostControllerSupervisor?ac=search",
                            method: "POST",
                            data: {get: da},
                            success: function (data) {
                ...
                $("#cancledate").click(function () {
                    $.ajax({
                        url: "../PostControllerSupervisor?ac=viewP",
                        method: "GET",
                        success: function (data) {
                            let rs = $.parseJSON(data);
                            console.log(rs)
                ...
                $("#1day").click(function () {
                    ...
                    console.log(da)
                    $.ajax({
                        url: "../PostControllerSupervisor?ac=search1",
                        method: "POST",
                        data: {get: da},
                        success: function (data) {
                            let obj = $.parseJSON(data);
                ...
                $("#orther").mouseenter(function (event) {
                    $.ajax({
                        url: "../PostControllerSupervisor?ac=viewTotalPost",
                        method: "GET",
                        success: function (data) {
                            let rs = $.parseJSON(data);
                            console.log(rs)
