            ...
            <div class="row">
              <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="aa-header-left">
                  <div class="aa-telephone-no" style="    text-shadow: 3px 3px 4px #080808;
    color: #fff;">
              ...
              <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="aa-header-right">
                  ...
                  <a class="aa-login" style ="color:white; 
                                            text-shadow: 3px 3px 4px #080808;
                                            width: 0px;
                                            font-size: 15px;transform: translateX(-40px); line-height: 1.4" href="<c:url value ='/login.jsp' />">Login</a>
                </div>
              </div>
            </div>
          </div>
