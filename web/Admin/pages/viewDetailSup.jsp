                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="p-3 py-5">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-12" >Phone <input id="phone" type="text" class="form-control" readonly="true"></div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-md-6">Category <input type="text" id="role" class="form-control" readonly="true"></div>
