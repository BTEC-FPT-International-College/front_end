<%-- 
    Document   : viewDetailByPost
    Created on : 11-11-2021, 20:28:46
    Author     : nguyenbamang
--%>
...
<html>
    <head>
        ...
        <title>Transactin History by Post Page</title>
                                ...
                                <div class="card-body">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="tran_post.jsp">Transaction History List</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Transaction History Management by Post</li>
                                        </ol>
                                    </nav>
                                    <h2 class="card-body" style="text-align: center;">Transaction history List of Post<%=request.getParameter("id")%></h2>
