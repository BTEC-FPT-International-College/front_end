...
public class Post {
    ...
    public Post(String PostID, String Title, String avartar, double price, double area, String Description, String phone, String Email, String UserID, int Total_View, String Create_Date, String Create_Hour, String Update_Date, int PostType, String status, int ReadUnread, String Location, String Category, int Priod, String EndDate) {
        this.PostID = PostID;
        this.Title = Title;
