...
<head>
    ...
    <link rel="stylesheet" href="../css/style-manage-post.css">
...
<!--    &lt;!&ndash; price picker slider &ndash;&gt;-->
<!--    <link rel="stylesheet" type="text/css" href="css/nouislider.css">-->
<!--    &lt;!&ndash; Fancybox slider &ndash;&gt;-->
          ...
          <div class="aa-header-area" style="padding: 0px; line-height: 1;">
            <div class="row">
              ...
              <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="aa-header-right" style="cursor: pointer;">
                  <div href="register.html" class="aa-icon" style="border: 1px solid #fff;"></div>
                  <div href="signin.html" class="aa-login">Minh Minh
        ...
        <div class="container">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul id="top-menu" class="nav navbar-nav navbar-right aa-main-nav">
              ...
              <li style="background-color: #ac2925"><a href="thai2/newpost.html" class="post-button">CREATE POST <i
            ...
            <div class="content1">
                ...
                <div class="content1-below">
                    <div class="management">MANAGE POST
                            ...
                            <li class="management-des"><a href="manager-post.html"><i class="fas fa-list-ol"></i> LIST OF POSTS </a></li>
                    </div>
                    <script>
                    ...
                    <div class="management">MANAGEMENT WALLET
                        <li class="management-des"><a href="thai2/deposit-money.html"> <i class="fas fa-wallet"></i> BALANCE</a></li>
                        <li class="management-des"><a href="#"><i class="fas fa-history"></i>  TRANSACTION HISTORY </a></li>
                        <li class="management-des"><a href="#"><i class="fas fa-money-check-alt"></i>  DEPOSIT MONEY IN YOUR WALLET </a></li>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12" id="a-hover">
                            <table class="table table-bordered" id="table-update-form">
                                ...
                                <tr>
                                    <td>12324312</td>
                                    <td>VINHOME: Industrial and modern style 3-bedrom</td>
                                    <td>24/10/2021</td>
                                    <td>5000</td>
                                    <td>Posted</td>
                                    <td>15/11/2021</td>
                                ...
                                <tr>
                                    <td>12567312</td>
                                    <td>VINHOME: Industrial and modern style 5-bedrom</td>
                                    <td>6/10/2021</td>
                                    <td>70,567</td>
                                    <td>Posted</td>
                                    <td>12/11/2021</td>
                                ...
                                <tr>
                                    <td>1213312</td>
                                    <td>VINHOME: Industrial and modern style 4-bedrom</td>
                                    <td>5/10/2021</td>
                                    <td>123,789</td>
                                    <td>Posted</td>
                                    <td>29/11/2021</td>
                                ...
                                <tr>
                                    <td>12312</td>
                                    <td>Ciputra: Industrial and modern s</td>
                                    <td>1/10/2021</td>
                                    <td>106,789</td>
                                    <td>Expired</td>
                                    <td>20/10/2021</td>
