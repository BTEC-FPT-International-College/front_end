		...
		<div class="aa-top-slider">
			...
			<div class="aa-top-slider-single">
				<a
					...
					target="_blank"> <img src="img/slider/5.png" alt="img">
				</a>
				<!-- Top slider content -->
				<div class="aa-top-slider-content">
					<span class="aa-top-slider-catg">VINHOME</span>
					...
					<c:forEach items="${posts}" var="p">
						<div class="col-md-4">
							<article class="aa-properties-item">
									<a href="#" class="aa-properties-item-img"> <img
										src="${p.getAvartar()}" alt="img">
									</a>
									<div class="aa-tag for-${p.getSale_rent()}">For ${p.getSale_rent()}</div>
									<div class="aa-properties-item-content">
										<div class="aa-properties-info">
											<span>${p.getRoom()} Rooms</span>  <span>${p.getBath()} Baths</span>
											<span>Area: ${p.getArea()} m²</span>
										</div>
										...
										<div id="post-location"><i class="fa fa-map-marker">${p.getLocation()}</i></div>
										<div class="aa-properties-detial">
											<span class="aa-price"> $ ${p.getPrice()}</span> <a href="#"class="aa-secondary-btn">View Details</a>
										</div>
								</div>
							</article>
							</div>
						...
						<div class="aa-agents-content">
							<ul class="aa-agents-slider">
								...
								<li>
									<div class="aa-single-agents">
										<div class="aa-agents-img">
											<img src="template/img/group/download.png" alt="Featured Investor">
										</div>
										<div class="aa-agetns-info">
											<h4>
												<a href="#">BTEC LAND</a>
								...
								<li>
									<div class="aa-single-agents">
										<div class="aa-agents-img">
											<img src="template/img/group/fpt-mb.png" alt="Featured Investor">
										</div>
										<div class="aa-agetns-info">
											<h4>
												<a href="#">FPT GROUP</a>
