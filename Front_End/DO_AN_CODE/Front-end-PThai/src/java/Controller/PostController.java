...
public class PostController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equals("add")) {
            ...
            boolean a = am.addPost(pos.getTitle(), pos.getAvatar(), pos.getArea(), pos.getPrice(), pos.getSaleRent(), pos.getLocation(), pos.getDescription(), pos.getCreateDay(), pos.getPostType(), pos.getEndDay(), pos.getRoom(), pos.getBath(), pos.getUserId());
