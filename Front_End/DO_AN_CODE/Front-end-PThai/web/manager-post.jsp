                                                                     ...
                                                                     $.each(o, function (key, value) {
                                                                        ...
                                                                        if (value.updateDay) {
                                                                         ...
                                                                         t.row.add([
                                                                                ...
                                                                                + '<div class="modal fade" id="hellohello" tabindex="-1" role="dialog" aria-hidden="true" style=\'display:none\' >'
                                                                                + '<div class="modal-dialog modal-dialog-centered" role="document" style="transform: translateX(-956px);">'
