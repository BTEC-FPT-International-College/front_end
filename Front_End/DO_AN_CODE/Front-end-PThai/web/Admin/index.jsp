        ...
        %>
            $(document).ready(function () {
                $('#dtOrderExample').DataTable({
                    ...
                    $.ajax({
                        url: "../MainControllersAdmin?ac=viewInfor",
                        method: "GET",
                                ...
                                <div class="card-body dashboard-tabs p-0">
                                    ...
                                    <div class="tab-content py-0 px-0">
                                        <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                                            ...
                                            <jsp:forward page = "../MainControllersAdmin?ac=viewTop1Post" />
                                        </c:if>
                                       ...
                                       <a href="pages/viewDetailByPost.jsp?id=${x.getWalletID()}">ID: ${x.getWalletID()}- ${x.getTotalValue()}</a>
                                            ...
                                            <jsp:forward page = "../MainControllersAdmin?ac=viewTop1" />
                                        </c:if>
                                ...
                                <div class="card-body">
                                    ...
                                    <script>
                                        ...
                                        <c:if test="${empty requestScope['listMonth']}">
                                            <jsp:forward page = "../MainControllersAdmin?ac=viewMonth" />
                                        </c:if>
                                ...
                                <div class="card-body">
                                    ...
                                    <script>
                                        ...
                                        <c:if test="${empty requestScope['listYear']}">
                                            <jsp:forward page = "../MainControllersAdmin?ac=viewYear" />
                                        </c:if>
                                        ...
                                        <table id="dtOrderExample" class="table">
                                            ...
                                            <tbody>
                                                <c:if test="${empty requestScope['listR']}">
                                                    <jsp:forward page = "../MainControllersAdmin?ac=view" />
                                                </c:if>
