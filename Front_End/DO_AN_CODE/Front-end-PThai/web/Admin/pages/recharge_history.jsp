            ...
            $(document).ready(function () {
                ...
                $("#getdate").click(function () {
                    ...
                    if ((end - start) < 0) {
                        ...
                        console.log(da)
                        $.ajax({
                            url: "../../RechargeControllerAdmin?ac=search",
                            method: "POST",
                            data: {get: da},
                ...
                $("#cancledate").click(function () {
                    $.ajax({
                        url: "../../RechargeControllerAdmin?ac=viewR",
                        method: "GET",
                        success: function (data) {
                ...
                $("#top3").click(function (event) {
                    $.ajax({
                        url: "../../RechargeControllerAdmin?ac=viewTop3",
                        method: "GET",
                        success: function (data) {
                            let rs = $.parseJSON(data);
                            console.log(rs)
                ...
                $("#orther").mouseenter(function (event) {
                    $.ajax({
                        url: "../../RechargeControllerAdmin?ac=viewTop1Recharge",
                        method: "GET",
                        success: function (data) {
                            let rs = $.parseJSON(data);
                            console.log(rs)
                ...
                $("#1hour").click(function () {
                    $.ajax({
                        url: "../../RechargeControllerAdmin?ac=viewRby1Hour",
                        method: "GET",
                        success: function (data) {
                            let rs = $.parseJSON(data);
                            console.log(rs)
                ...
                $("#1day").click(function () {
                    ...
                    console.log(da)
                    $.ajax({
                        url: "../../RechargeControllerAdmin?ac=search1",
                        method: "POST",
                        data: {get: da},
                        success: function (data) {
                            let obj = $.parseJSON(data);
                                        ...
                                        <table id="dtOrderExample" class="table table-striped table-bordered" style="width:100%">
                                            ...
                                            <tbody>
                                                <c:if test="${empty requestScope['listR']}">
                                                    <jsp:forward page = "../../RechargeControllerAdmin?ac=view" />
                                                </c:if>
