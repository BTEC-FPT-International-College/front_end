...
CREATE TABLE `user_wallet` (
  ...
  KEY `userid` (`userid`),
  CONSTRAINT `userid` FOREIGN KEY (`userid`) REFERENCES `tbl_user` (`userid`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `user_wallet` VALUES (1,123229,'20-11-2021','US000001'),(2,5,'20-11-2021','US000002'),(3,7,'20-11-2021','US000003');
