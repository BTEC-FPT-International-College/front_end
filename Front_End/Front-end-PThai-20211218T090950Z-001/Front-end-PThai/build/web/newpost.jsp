...
<!--            <div class="alert alert-danger alert-dismissible fade show" id="error" role="alert" style="display: none">
          ...
          <div class=" content3__child content3__contact">
            <h2>Contact Info</h2>
            <h4>Contact name*</h4>
            <input placeholder="Nh?p tên liên h?"  type="text" style="width: 344px;" id="name-contact" class="input-exist" value="Tran Minh Minh (BTEC HN)">
            <h4>Phone number*</h4>
            <input placeholder="Nh?p tên liên h?"  type="text" class="input-exist" id="phone-contact" value="9999999999">
            <h4>Email</h4>
            <input placeholder="Nh?p tên liên h?"  type="text" class="input-exist" id="mail-contact" value="minhminh@gmail.com">
            <h4>Address</h4>
