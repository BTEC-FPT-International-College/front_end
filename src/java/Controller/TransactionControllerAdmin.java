...
import Model.TransactionModelAdmin;
 ...
 * @author MarkTran
 */
@WebServlet(name = "TransactionControllerAdmin", urlPatterns = {"/TransactionControllerAdmin"})
public class TransactionControllerAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (act.equals("view")) {
            TransactionModelAdmin am = new TransactionModelAdmin();
            ArrayList<Transaction_History> list = am.getListTransaction();
            request.setAttribute("listTran", list);
            request.getRequestDispatcher("Admin/pages/tran_post.jsp").forward(request, response);
        }
