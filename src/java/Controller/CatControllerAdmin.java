 ...
 * @author MarkTran
 */
@WebServlet(name = "CatControllerAdmin", urlPatterns = {"/CatControllerAdmin"})
public class CatControllerAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String act = request.getParameter("ac");
            ...
            request.getRequestDispatcher("Admin/pages/cate.jsp").forward(request, response);
        }
        if (act.equals("add")) {
