    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (act.equals("updateStatus")) {
            ...
            if(a){
               ...
               UserAdmin user = am.getUser(u.getUserID());
                SendMail sen = new SendMail();
               String toMail = user.getEmail();
               if(u.getStatus() == 1){
                b = sen.sendEmail("Notice from BTEC LAND for violating community standards", "Your account has been temporarily locked for not complying with the regulations of BTEC LAND.", toMail);
               }else{
                b = sen.sendEmail("Notice about unblock account from BTEC LAND", "Through the review process as well as your cooperation, we decided to unblock your account. Please comply with the standards and regulations set forth by BTEC LAND!!!", toMail);
               }
            }
