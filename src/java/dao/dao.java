    ...
    public ArrayList<Post> getListPost() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                p.setDistrict(rs.getString(25));
                p.setWard(rs.getString(24));
...
"                tbl_user.reward_point DESC,\n" +
"                tbl_post.postid DESC LIMIT 6 OFFSET ?");
        try {
            Statement stm = conn.createStatement();
            PreparedStatement st = conn.prepareStatement(sql);
            st.setInt(1, amount);
...
//          
    ...
    public List<Post> searchPost(String provincetxt, String districttxt, String saleOrRent, String category) {
       ...
       String sql = "SELECT * FROM web.tbl_post,tbl_user \n"
                ...
                + "	tbl_user.reward_point DESC, tbl_post.postid DESC LIMIT 24";
        try {
            PreparedStatement st = conn.prepareStatement(sql);
